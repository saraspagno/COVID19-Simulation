...
def start_console():
    print(constant.hello_string)
    space_or_enter = input(constant.enter_parameters)
    ...
    N = input(constant.enter_N)
    while (not N.isdigit()) or int(N) > 40000:
        print("Wrong input.")
        N = input(constant.enter_N)
    constant.N = int(N)

    D = input(constant.enter_D)
    while True:
        try:
            D = float(D)
        except ValueError:
    ...
    R = input(constant.enter_R)
    while (not R.isdigit()) or int(R) > 100:
        print("Wrong input.")
        R = input(constant.enter_R)
    constant.R = int(R)

    X = input(constant.enter_X)
    while (not X.isdigit()) or int(X) == 0:
        print("Wrong input.")
        X = input(constant.enter_X)
    constant.X = int(X)

    P_1 = input(constant.enter_P_1)
    while True:
        try:
            P_1 = float(P_1)
        except ValueError:
